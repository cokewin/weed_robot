...
#ifndef canopen_ros2_controller__CONTROLLER__TEST_CANOPEN_PROXY_CONTROLLER_HPP_
#define canopen_ros2_controller__CONTROLLER__TEST_CANOPEN_PROXY_CONTROLLER_HPP_
...
using ControllerStateMsg = canopen_ros2_controller::CanopenProxyController::ControllerNMTStateMsg;
...
using ControllerModeSrvType =
  canopen_ros2_controller::CanopenProxyController::ControllerStartResetSrvType;
...
class TestableCanopenProxyController : public canopen_ros2_controller::CanopenProxyController
{
...
public:
  ...
  {
    auto ret = canopen_ros2_controller::CanopenProxyController::on_configure(previous_state);
...
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerCommandMsg>(
      "/test_canopen_ros2_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_canopen_ros2_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(
    bool set_parameters = true, std::string controller_name = "test_canopen_ros2_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_canopen_ros2_controller/state", 10, subs_callback);
...
#endif  // canopen_ros2_controller__CONTROLLER__TEST_CANOPEN_PROXY_CONTROLLER_HPP_
