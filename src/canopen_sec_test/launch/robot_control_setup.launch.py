...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [
                    FindPackageShare("canopen_sec_test"),
    ...
    robot_control_config = PathJoinSubstitution(
        [FindPackageShare("canopen_sec_test"), "config/robot_control", "ros2_controllers.yaml"]
    )

    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("canopen_sec_test"), "rviz", "robot_controller.rviz"]
    )
    ...
    slave_config = PathJoinSubstitution(
        [FindPackageShare("canopen_sec_test"), "config/robot_control", "cia402_slave.eds"]
    )
